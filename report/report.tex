...
\midrule
TCN18-045 & TCN18-245 & $0.980 \pm 0.019$ & $0.981 \pm 0.018$ & Comparison of reference measurements \\
TCN18-029 & TCN18-031 & $0.779 \pm 0.007$ & \sout{$0.855 \pm 0.008$} & Adding elbow before detector \\
TCN18-035 & TCN18-031 & $0.895 \pm 0.010$ & $0.906 \pm 0.014$ & UGD22+IV3 compared to UGD17\\
TCN18-045 & TCN18-035 & $1.017 \pm 0.016$ & $1.041 \pm 0.016$ & Flipping IV2 and IV3\\
TCN18-053 & TCN18-045 & $1.029 \pm 0.019$ & \sout{$0.955 \pm 0.015$} & Replacing UGD22 with burst disk and UGD2 \\
TCN18-053 & TCN18-480 & $0.996 \pm 0.016$ & $0.994 \pm 0.015$ & Burst disk compared to UGD22 \\
TCN18-057 & TCN18-053 & $0.939 \pm 0.016$ & $0.969 \pm 0.014$ & Vent spider compared to burst disk \\
TCN18-085 & TCN18-045 & $1.031 \pm 0.018$ & \sout{$0.973 \pm 0.015$} & Adding UGD19 (NiP) \\
TCN18-085 & TCN18-480 & $0.998 \pm 0.014$ & $1.012 \pm 0.015$ & UGD19 (NiP) compared to UGD2 \\
TCN18-090 & TCN18-045 & $0.919 \pm 0.016$ & \sout{$0.905 \pm 0.015$} & Adding UGG3 with UGA11+3 \\
TCN18-090 & TCN18-480 & $0.900 \pm 0.013$ & $0.941 \pm 0.015$ & UGG3 with UGA11+3 compared to UGD2 \\
TCN18-290 & TCN18-045 & $0.955 \pm 0.019$ & \sout{$0.893 \pm 0.015$} & Adding UGG3 with UGA5+6\\
TCN18-290 & TCN18-480 & $0.924 \pm 0.017$ & $0.929 \pm 0.015$ & UGG3 with UGA5+6 compared to UGD2\\
TCN18-060 & TCN18-045 & $1.010 \pm 0.016$ & \sout{$0.955 \pm 0.019$} & Replacing UGD22 with UGD10 + 17 + 11 \\
TCN18-065 & TCN18-045 & $0.977 \pm 0.017$ & \sout{$0.894 \pm 0.014$} & Replacing UGD22 with SCM warm bore \\
TCN18-065 & TCN18-060 & $0.968 \pm 0.014$ & $0.936 \pm 0.018$ & Warm bore compared to UGD10 + 17 + 11 \\
...
\begin{figure}
\centering
\includegraphics[width=\textwidth,page=6]{{"../transmission/TCN18-045 (IV2+UGD22+IV3, O-rings in)"}.pdf}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth,page=9]{{"../transmission/TCN18-045 (IV2+UGD22+IV3, O-rings in)"}.pdf}
...
To determine the storage lifetime in different guide components we ran experiments with three periods per cycle. An irradiation period, where UCN are produced and filled into the component to measure with the valve to the detector closed. A storage period, where the irradiation is stopped and the UCN valves between source and component might be closed. And a counting period, where the valve to the detector is opened to count the UCN remaining within the guide volume. The He3 detector again serves as monitor detector, measuring the UCN density filled into the component during irradiation.

Additionally, the He3 detector can measure the storage lifetime in the guide volume connected to it using a ``pinhole method''.

\subsection{Storage method}

In the classical storage method, remaining UCN are counted with the Li6 detector. The background is subtracted using equations (\ref{eq:transmission_begin})--(\ref{eq:background_subtraction_end}) and then normalized using the counts in the He3 detector during irradiation, see equations (\ref{eq:normalization_irradiation_begin})--(\ref{eq:normalization_irradiation_end}). To avoid similar issues with normalization as in the transmission experiments, only the He3 counts during the last $\Delta t = \SI{10}{\second}$ of the irradiation period are used.

\begin{figure}
\centering
\includegraphics[width=\textwidth,page=1]{{"../storagelifetime_with_monitor/TCN18-082 (UGD22+2, IV1-IV3)"}.pdf}
...
During these experiments, the source is never directly connected to the vacuum pump on the Li6 detector and the vapor pressure variations are much smaller between the cycles. Additionally, all cycles of each experiment are run within a short period of time (typically less than an hour) and are not compared to other experiments (potentially run weeks later), as with the transmission measurements. Hence, short-term variations in the source are small and long-term variations are no concern, and the stability of the normalization is much less of an issue.

\subsection{Pinhole method}

\begin{figure}
\centering
\includegraphics[width=\textwidth,page=7]{{"../storagelifetime_with_monitor/TCN18-082 (UGD22+2, IV1-IV3)"}.pdf}
\caption{Rate in the He3 detector during storage in the guides between valves IV1 and IV3, including UGD22 and UGD2. A single exponential fit from \SI{5}{\second} after the irradiation stopped to the moment the valve to the detector opened determines the storage lifetime.}
\label{fig:storagelifetime_with_monitor_He3}
\end{figure}

The rate in the He3 detector is directly proportional to the number of UCN in the guide volume connected to the He3 detector via its pinhole. Therefore, it should see a rate dropping exponentially with the same storage lifetime. For each cycle, we can fit a single exponential with storage lifetime $\tau_\mathrm{p}$ to the He3 rate between the time the irradiation stops and the valve to the detector opens, see fig.~\ref{fig:storagelifetime_with_monitor_He3}. To leave some time for valves closing and the UCN distribution settling in the storage volume, we excluded the first \SI{5}{\second} of the storage period from the fit.

A weighted average over all cycles $\bar{\tau}_\mathrm{p}$ gives a very precise measurement of the storage lifetime.
...
\begin{figure}
\centering
\includegraphics[width=\textwidth,page=1]{{"../storagelifetime_with_monitor/TCN18-066"}.pdf}
\includegraphics[width=\textwidth,page=1]{{"../storagelifetime_with_monitor/TCN18-068"}.pdf}
\caption{Storage lifetime in the SCM, without foil, between IV2 and IV3 (top) and between IV1 and IV3 (bottom). The storage lifetime determined with the pinhole method is shown in red.}
\label{fig:SCM_storage_no_foil}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\textwidth,page=1]{{"../storagelifetime_with_monitor/TCN18-266"}.pdf}
\includegraphics[width=\textwidth,page=1]{{"../storagelifetime_with_monitor/TCN18-268"}.pdf}
\caption{Storage lifetime in the SCM, with foil installed, between IV2 and IV3 (top) and between IV1 and IV3 (bottom). The storage lifetime determined with the pinhole method is shown in red.}
\label{fig:SCM_storage_with_foil}
\end{figure}

When storing UCN in the superconducting polarizer magnet without the foil in place, storage lifetime dropped with increasing magnet current, see fig.~\ref{fig:SCM_storage_no_foil}. As in the other storage-lifetime measurements, the pinhole method measured shorter storage lifetimes. After installing the foil, the storage lifetime was reduced dramatically and no clear correlation with magnetic current could be observed anymore, see fig.~\ref{fig:SCM_storage_with_foil}.
